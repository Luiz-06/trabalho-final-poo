...
var App = /** @class */ (function () {
  function App() {
    ...
    if (!perfilAdm) {
      var novoPerfilAdm =
        perfilAvancado_1.PerfilAvancado.criarPerfilAdministrador();
  ...
  App.prototype.start = function () {
    ...
    while (!this._isLoggedIn) {
      ...
      switch (opcao) {
        ...
        case "2":
          this.criarConta();
          (0, auxFunctions_1.salvarDadosPerfis)(
        ...
        default:
          (0, auxFunctions_1.print)(
            "\x1b[33m⚠ Opção inválida! Tente novamente. ⚠\x1b[0m"
          );
      }
    }
    this.menuPrincipal();
  ...
  App.prototype.criarConta = function () {
    ...
    var apelido = (0, auxFunctions_1.getData)(
    ...
    var novoPerfil = new perfil_1.Perfil(
      (0, ulid_1.ulid)(),
      apelido,
      email,
      foto,
  ...
  App.prototype.recuperarSenha = function () {
    ...
    if (perfilDesejado) {
      var emailAssociado =
        perfilDesejado === null || perfilDesejado === void 0
          ? void 0
          : perfilDesejado.email;
      (0, auxFunctions_1.print)(
        "Um e-mail de recupera\u00E7\u00E3o foi enviado para ".concat(
          emailAssociado,
          ". Verifique sua caixa de entrada!"
        )
      );
      var codRecuperacao = (0, auxFunctions_1.getData)(
  ...
  App.prototype.loginPerfilAvancado = function () {
    ...
    if (perfil && perfil.stats) {
      ...
      if (
        perfilAvancado_1.PerfilAvancado.isPerfilAvancado(perfil) &&
  ...
  App.prototype.criarNovoPerfilAvancado = function () {
    try {
      if (perfilAvancado_1.PerfilAvancado.isPerfilAvancado(this._perfilAtual)) {
        ...
        var email = (0, auxFunctions_1.getData)("📧 Digite seu email: ");
        var senha = (0, auxFunctions_1.getData)("🔐 Escolha uma senha: ");
        var novoPerfilAvancado =
          perfilAvancado_1.PerfilAvancado.criarNovoPerfilAvancado(
            apelido,
            email,
            senha
          );
      ...
      console.log(
        "\n\u001B[31m\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557\n\u2551                                          \u2551\n\u2551   \u274C Erro ao criar perfil avan\u00E7ado: ".concat(
          error.message,
          " \u2551\n\u2551                                          \u2551\n\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255D\u001B[0m"
        )
      );
  ...
  App.prototype.criarPerfilComum = function () {
    try {
      if (perfilAvancado_1.PerfilAvancado.isPerfilAvancado(this._perfilAtual)) {
        ...
        var email = (0, auxFunctions_1.getData)("📧 Digite seu email: ");
        var senha = (0, auxFunctions_1.getData)("🔐 Escolha uma senha: ");
        var novoPerfilComum = new perfil_1.Perfil(
          (0, ulid_1.ulid)(),
          apelido,
          email,
      ...
      console.log(
        "\n\u001B[31m\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557\n\u2551                                          \u2551\n\u2551   \u274C Erro ao criar perfil comum: ".concat(
          error.message,
          " \u2551\n\u2551                                          \u2551\n\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255D\u001B[0m"
        )
      );
  ...
  App.prototype.menuPrincipal = function () {
    ...
    do {
      this.exibirTitulo(
        "Bem-vindo, ".concat(
          (_a = this._perfilAtual) === null || _a === void 0
            ? void 0
            : _a.apelido
        )
      );
      ...
      switch (opcao) {
        ...
        case "4":
          if (
            perfilAvancado_1.PerfilAvancado.isPerfilAvancado(this._perfilAtual)
          ) {
  ...
  App.prototype.menuPerfil = function () {
    ...
    do {
      ...
      switch (opcao) {
        ...
        case "0":
          (0, auxFunctions_1.print)(
            "\x1b[32m↩ Voltando ao Menu Principal... ↩\x1b[0m"
          );
          break;
        default:
          (0, auxFunctions_1.print)(
  ...
  App.prototype.criarPublicacao = function () {
    var novaPublicacao = this._redeSocial.criarPublicacao(
  ...
  App.prototype.listarMinhasPublicacoes = function () {
    var publicacoes = this._redeSocial.listarPublicacoes(
      this._perfilAtual.apelido
    );
  ...
  App.prototype.editarPublicacao = function () {
    ...
    publicacoes.forEach(function (pub, index) {
      console.log(
        "\u001B[34m".concat(index + 1, ". ").concat(pub.conteudo, "\u001B[0m")
      );
    });
    var escolha =
      (0, auxFunctions_1.getNumber)("\n➤ Digite o número da publicação: ") - 1;
    ...
    var novoConteudo = (0, auxFunctions_1.getData)(
      "\x1b[34m✏️  Digite o novo conteúdo: \x1b[0m"
    );
    var sucesso = this._redeSocial.editarPublicacao(
      this._perfilAtual.apelido,
  ...
  App.prototype.excluirPublicacao = function () {
    ...
    var publicacaoSelecionada = publicacoes[escolha];
    var confirmacao = (0, auxFunctions_1.getData)(
      "\x1b[31m❗ Tem certeza que deseja excluir esta publicação? (s/n): \x1b[0m"
    );
    if (confirmacao.toLowerCase() === "s") {
      var sucesso = this._redeSocial.deletarPublicacao(
        this._perfilAtual.apelido,
        publicacaoSelecionada.id
      );
      if (sucesso) {
      ...
      publicacoes.forEach(function (pub, index) {
        ...
        console.log(
          "\n\u001B[34m"
            ...
            .concat(pub.dataHora.toLocaleString(), "\n   \uD83D\uDC64 Autor: ")
            .concat(
              ((_a = _this._redeSocial.buscarPerfilPorID(
                pub.perfilAssociado
              )) === null || _a === void 0
                ? void 0
                : _a.apelido) || "Desconhecido",
              "\n      \u001B[0m"
            )
        );
        // Se for uma PublicacaoAvancada, mostrar interações
        if (
          pub instanceof publicacaoAvancada_1.PublicacaoAvancada ||
          publicacaoAvancada_1.PublicacaoAvancada.isPublicacaoAvancada(pub)
        ) {
          var publicacaoAvancada =
            pub instanceof publicacaoAvancada_1.PublicacaoAvancada
              ? pub
              : Object.assign(
                  new publicacaoAvancada_1.PublicacaoAvancada(
                    pub.id,
                    pub.conteudo,
                    pub.dataHora,
                    pub.perfilAssociado
          ...
          console.log(
            "   \uD83D\uDC4D Curtir: ".concat(
              contagemInteracoes[tipoInteracao_1.TipoInteracao.Curtir]
            )
          );
          console.log(
            "   \uD83D\uDC4E N\u00E3o Curtir: ".concat(
              contagemInteracoes[tipoInteracao_1.TipoInteracao.NaoCurtir]
            )
          );
          console.log(
            "   \uD83D\uDE02 Riso: ".concat(
              contagemInteracoes[tipoInteracao_1.TipoInteracao.Riso]
            )
          );
          console.log(
            "   \uD83D\uDE2E Surpresa: ".concat(
              contagemInteracoes[tipoInteracao_1.TipoInteracao.Surpresa]
            )
          );
        }
      });
  ...
  App.prototype.visualizarSolicitacoes = function () {
    var solicitacoes = this._redeSocial.listarSolicitacoes(
      this._perfilAtual.apelido
    );
    ...
    if (solicitacoes) {
      if (solicitacoes.length === 0) {
        ...
        solicitacoes.forEach(function (perfil, index) {
          console.log(
            "Id: ".concat(index + 1, " - Usu\u00E1rio: ").concat(perfil)
          );
        });
  ...
  App.prototype.enviarSolicitacao = function () {
    ...
    try {
      ...
      usuariosAtuais.forEach(function (perfil, index) {
        ...
        if (
          perfil["_apelido"] !==
          ((_a = _this._perfilAtual) === null || _a === void 0
            ? void 0
            : _a.apelido)
        ) {
          var isAmigo =
            (_b = _this._perfilAtual) === null || _b === void 0
              ? void 0
              : _b.amigos.includes(perfil["_apelido"]);
          console.log(
            "Id: "
              .concat(index + 1, " - Usu\u00E1rio: ")
              .concat(perfil["_apelido"])
              .concat(isAmigo ? " (amigos)" : "")
          );
        }
      });
      var index = (0, auxFunctions_1.getNumber)(
  ...
  App.prototype.alterarApelido = function () {
    var novoApelido = (0, auxFunctions_1.getData)(
      "\x1b[34m👤 Insira o novo apelido: \x1b[0m"
    );
    try {
  ...
  App.prototype.alterarEmail = function () {
    var novoEmail = (0, auxFunctions_1.getData)(
      "\x1b[34m📧 Insira o novo email: \x1b[0m"
    );
    try {
  ...
  App.prototype.alterarSenha = function () {
    if (validations.validationTrocarSenha(this._perfilAtual.senha)) {
      var novaSenha = (0, auxFunctions_1.getData)(
        "\x1b[34m🔐 Insira a nova senha: \x1b[0m"
      );
      ...
      amigos.forEach(function (amigo, index) {
        ...
        console.log(
          "\n\u001B[34m"
            ...
            .concat(amigo, "\n   \uD83D\uDCE7 ")
            .concat(
              (perfilAmigo === null || perfilAmigo === void 0
                ? void 0
  ...
  App.prototype.removerAmigo = function () {
    ...
    var confirmacao = (0, auxFunctions_1.getData)(
      "\u001B[31m\u2757 Tem certeza que deseja remover ".concat(
        amigoParaRemover,
        "? (s/n): \u001B[0m"
      )
    );
  ...
  App.prototype.editarPerfilComum = function () {
    if (perfilAvancado_1.PerfilAvancado.isPerfilAvancado(this._perfilAtual)) {
      var apelido = (0, auxFunctions_1.getData)(
        "👤 Apelido do perfil a ser editado: "
      );
      var perfil = this._redeSocial.buscarPerfil(apelido);
      if (perfil) {
  ...
  App.prototype.excluirPerfilComum = function () {
    if (perfilAvancado_1.PerfilAvancado.isPerfilAvancado(this._perfilAtual)) {
      var apelido = (0, auxFunctions_1.getData)(
        "👤 Apelido do perfil a ser excluído: "
      );
      var perfil = this._redeSocial.buscarPerfil(apelido);
      if (perfil) {
  ...
  App.prototype.fazerPublicacaoAvancada = function () {
    try {
      if (perfilAvancado_1.PerfilAvancado.isPerfilAvancado(this._perfilAtual)) {
        ...
        var conteudo = (0, auxFunctions_1.getData)(
          "✍️ Digite o conteúdo da publicação: "
        );
        var novaPublicacao = new publicacaoAvancada_1.PublicacaoAvancada(
          "SUPER" + (0, ulid_1.ulid)(),
          conteudo,
          new Date(),
        ...
        (0, auxFunctions_1.salvarDadosPublicacoes)(
      ...
      console.log(
        "\n\u001B[31m\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557\n\u2551                                          \u2551\n\u2551   \u274C Erro ao criar publica\u00E7\u00E3o avan\u00E7ada: ".concat(
          error.message,
          " \u2551\n\u2551                                          \u2551\n\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255D\u001B[0m"
        )
      );
  ...
  App.prototype.interagirPublicacaoAvancada = function () {
    try {
      if (perfilAvancado_1.PerfilAvancado.isPerfilAvancado(this._perfilAtual)) {
        ...
        publicacoesAvancadas.forEach(function (pub, index) {
          console.log(
            "\u001B[34m"
              .concat(index + 1, ". ")
              .concat(pub.conteudo.substring(0, 50), "...\u001B[0m")
          );
        });
        // Selecionar publicação para interagir
        var escolhaPublicacao =
          (0, auxFunctions_1.getNumber)(
            "\n➤ Escolha o número da publicação: "
          ) - 1;
        if (
          escolhaPublicacao < 0 ||
        ...
        // Criar interação
        var novaInteracao = new interacao_1.Interacao(
          (0, ulid_1.ulid)(),
          tipoInteracao,
          this._perfilAtual.apelido
        );
      ...
      console.log(
        "\n\u001B[31m\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557\n\u2551                                          \u2551\n\u2551   \u274C Erro ao interagir com publica\u00E7\u00E3o: ".concat(
          error.message,
          " \u2551\n\u2551                                          \u2551\n\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255D\u001B[0m"
        )
      );
